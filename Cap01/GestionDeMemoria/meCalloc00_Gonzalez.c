...
int main(){
  ...
  int *p3=calloc(5,sizeof *p3); //Reserva memoria para 5 enteros e inicializa cada byte a 0
                                // calloc(5, sizeof *p3) es equivalente a calloc(5, sizeof(int))
 
  /**BUCLE PARA RELLENAR LOS ESPACIOS**/
  // Bucle para rellenar los espacios de 'puntero' con una secuencia de enteros
  ...
  // Liberación de la memoria reservada para evitar fugas de memoria
